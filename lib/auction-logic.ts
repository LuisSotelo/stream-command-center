...
export const AUCTION_LEVELS: DiscountLevel[] = [
  {
    ...
    minPrice: 1101,
    maxPrice: 1200,
    rates: { sub: 20, bits100: 15, bits500: 60, bits1000: 120 }
  },
  {
    name: "NIVEL 1",
    minPrice: 1001,
    maxPrice: 1100,
    rates: { sub: 25, bits100: 18, bits500: 70, bits1000: 140 },
  ...
  },
  {
    ...
    minPrice: 901,
    maxPrice: 1000,
    rates: { sub: 30, bits100: 20, bits500: 85, bits1000: 170 }
  },
  {
    name: "NIVEL 3",
    minPrice: 801,
    maxPrice: 900,
    rates: { sub: 40, bits100: 25, bits500: 100, bits1000: 200 },
  ...
  },
  {
    ...
    minPrice: 200,
    maxPrice: 800,
    rates: { sub: 50, bits100: 30, bits500: 120, bits1000: 240 }
  }
];
